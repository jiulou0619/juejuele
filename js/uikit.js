...
(function () {
  ...
  var EM = {
    ...
    '⛏': 'ic_pick', '🔨': 'ic_hammer', '🔧': 'ic_repair', '🧲': 'ic_magnet', '📏': 'ic_ruler', '🎯': 'ic_target',
    '🔥': 'ic_fire', '🌋': 'ic_volcano', '💥': 'ic_bomb', '💣': 'ic_bomb', '🧨': 'ic_bomb', '🚀': 'ic_rocket',
    '🌀': 'ic_wand', '🌈': 'ic_rainbow', '🎆': 'ic_spark', '✨': 'ic_spark', '💫': 'ic_spark', '⚡': 'ic_spark',
    '🪨': 'ic_stone', '⛰': 'ic_mountain', '🧊': 'ic_snow', '❄': 'ic_snow', '🦠': 'ic_toxic', '💨': 'ic_toxic',
    '🦴': 'ic_bone', '🦖': 'ic_bone', '🐚': 'ic_bone', '🦷': 'ic_bone', '🪲': 'ic_bone', '🐾': 'ic_bone', '🦇': 'ic_ghost',
    '❓': 'ic_quest', '❔': 'ic_quest', '📦': 'ic_chest', '🎁': 'ic_chest', '📺': 'ic_doc', '🦫': 'ic_shop',
    '🧩': 'ic_puzzle', '🛒': 'ic_shop', '📖': 'ic_book', '🎡': 'ic_wheel', '💪': 'ic_gym', '⚔': 'ic_axe',
    '📅': 'ic_calendar', '⏰': 'ic_clock', '⏱': 'ic_clock', '🕰': 'ic_clock', '📻': 'ic_bell', '🔔': 'ic_bell',
    ...
    '🍀': 'ic_clover', '🌿': 'ic_leaf', '🌸': 'ic_leaf', '🍋': 'ic_potion', '🍎': 'ic_potion', '🧪': 'ic_potion',
    '👻': 'ic_ghost', '🗿': 'ic_skull', '💀': 'ic_skull', '🕯': 'ic_light', '🔦': 'ic_light', '🏺': 'ic_potion',
    '⚙': 'ic_settings', '🔩': 'ic_ring', '🤖': 'ic_grid', '🎛': 'ic_grid', '🔋': 'ic_grid', '🔗': 'ic_ring', '⛓': 'ic_ring',
    '🔮': 'ic_gem2', '🟡': 'ic_coin', '🟣': 'ic_gem2', '💚': 'ic_clover', '💧': 'ic_gem', '🌊': 'ic_gem',
    '🐱': 'ic_ghost', '🕊': 'ic_ghost', '🕳': 'ic_stone', '💯': 'ic_star', '🔟': 'ic_star', '🧯': 'ic_repair',
